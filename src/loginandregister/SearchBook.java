...
public class SearchBook extends javax.swing.JFrame {
    ...
    public SearchBook(BookStorage storage, UserStorage userstorage) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (int i = 0; i < bookStorage.getCount(); i++) {
            ...
            if (b.getTitle().equalsIgnoreCase(query)) {
                ...
                String classification = b.getclassify();
                
                String info = "Book Found!\n\n" +
                          "Title: " + b.getTitle() + "\n" +
                          "Author: " + b.getAuthor() + "\n" +
                          "Pages: " + b.getPages() + "\n" +
        ...
        if (!found) {
            JOptionPane.showMessageDialog(this, "Sorry, that book was not found in our library.");
        }
