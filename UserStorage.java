...
public class RegisterFrame extends javax.swing.JFrame {
    ...
    public RegisterFrame(BookStorage storage, UserStorage userstorage) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("BOX LIBRARY");

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/loginandregister/Book icon.png"))); // NOI18N
...
public static String savedPassword;
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(firstname.isEmpty() || lastname.isEmpty() || email.isEmpty() || password.isEmpty()) {
            ...
            String result = userStorage.register(email, password);
